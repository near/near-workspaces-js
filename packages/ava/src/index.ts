...
export type AvaWorkspaceFn = (t: ava.ExecutionContext, args: AccountArgs, workspace: WorkspaceContainerInterface) => void | Promise<void>;
 ...
 * });
 */
export class Workspace extends RawWorkspace {
  /**
