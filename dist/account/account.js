...
class Account {
    ...
    async createAndDeploy(accountId, wasm, { attachedDeposit = types_2.NO_DEPOSIT, args = {}, gas = types_1.DEFAULT_FUNCTION_CALL_GAS, initialBalance, keyPair, method, } = {}) {
     ...
     */
    async call_raw(contractId, methodName, args, { gas = types_1.DEFAULT_FUNCTION_CALL_GAS, attachedDeposit = types_2.NO_DEPOSIT, signWithKey = undefined, } = {}) {
     ...
     */
    async call(contractId, methodName, args, { gas = types_1.DEFAULT_FUNCTION_CALL_GAS, attachedDeposit = types_2.NO_DEPOSIT, signWithKey = undefined, } = {}) {
