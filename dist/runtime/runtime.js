...
class Runtime {
    constructor(config, resultArgs) {
        ...
        this.serializeAccountArgs = (args) => {
        ...
        this.createAccount = async (name, keyPair) => {
        ...
        this.createAndDeploy = async (name, wasm) => {
