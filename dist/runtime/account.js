...
class Account {
    constructor(najAccount) {
         ...
         */
        this.call_raw = async (contractId, methodName, args, gas = new bn_js_1.default(25 * 10 ** 12), attachedDeposit = new bn_js_1.default('0')) => {
         ...
         */
        this.call = async (contractId, methodName, args, gas = new bn_js_1.default(30 * 10 ** 12), // TODO: import DEFAULT_FUNCTION_CALL_GAS from NAJ 
        ...
        this.view_raw = async (method, args = {}) => {
        ...
        this.viewState = async () => {
            return new ContractState(await this.najAccount.viewState(""));
        };
        this.patchState = async (key, val, borshSchema) => {
